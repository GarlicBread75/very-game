...
namespace Bitgem.VFX.StylisedWater
{
    ...
    public class WaterVolumeBase : MonoBehaviour
    {
        ...
        [FlagEnum] public TileFace IncludeFaces = TileFace.NegX | TileFace.NegZ | TileFace.PosX | TileFace.PosZ;

        [FlagEnum] public TileFace IncludeFoam = TileFace.NegX | TileFace.NegZ | TileFace.PosX | TileFace.PosZ;

        [Range(0f, 100f)] public float TileSize;
